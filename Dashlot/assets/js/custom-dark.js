(function($) {
	...
	$(document).on('click', '#myonoffswitch4', function(e){
		if (this.checked) {
			...
			$('body').removeClass('header-dark');
			$('body').removeClass('horizontalmenu-dark');
			$('body').removeClass('dark-hor-color');
	...
	$(document).on('click', '#myonoffswitch11', function(e){
		if (this.checked) {
			...
			$('body').removeClass('dark-hor-light');
			$('body').removeClass('header-color');
			$('body').removeClass('default');
			localStorage.setItem("dark-hor-color", "True");
		}
		else {
			$('body').removeClass('dark-hor-color');
			localStorage.setItem("dark-hor-color", "false");
		}
	});
	...
	$(document).on('click', '#myonoffswitch12', function(e){
		if (this.checked) {
			...
			$('body').removeClass('dark-hor-color');
			$('body').removeClass('default');
			localStorage.setItem("dark-hor-light", "True");
		}
		else {
			$('body').removeClass('dark-hor-light');
			localStorage.setItem("dark-hor-light", "false");
		}
	});
	...
	$(document).on('click', '#myonoffswitch7', function(e){
		if (this.checked) {
			...
			$('body').removeClass('header-dark');
			$('body').removeClass('header-color');
			$('body').removeClass('leftmenu-icon-color');
	...
	/*Leftmenu-Icon-Color*/
	$(document).on('click', '#myonoffswitch17', function(e){
		if (this.checked) {
			$('body').addClass('leftmenu-icon-color');
			$('body').removeClass('leftmenu-icon-light');
			$('body').removeClass('default');
			localStorage.setItem("leftmenu-icon-color", "True");
		}
		else {
			$('body').removeClass('leftmenu-icon-color');
			localStorage.setItem("leftmenu-icon-color", "false");
		}
	});
